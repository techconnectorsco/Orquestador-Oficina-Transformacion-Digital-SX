<script lang="ts">
	...
	let { agentForm, perfil, user } = $props<{ agentForm: any; perfil?: any; user?: User | null }>();
...
<div class="w-full">
	<!-- Hero Section -->
	<div class="bg-linear-to-r from-primary/10 to-primary/20 border-b-4 border-primary rounded-2xl shadow-lg mb-12 p-8 md:p-12">
		<div class="max-w-4xl">
